...
const cardsData = [
  { title: "Half-hourly flexible sessions", color: "bg-[#8E97FD]", position: "lg:top-[30%] lg:left-[18%]", icon: hourIcon },
  { title: "Influencer & celebrity access", color: "bg-[#F9A8D4]", position: "lg:top-[30%] lg:right-[18%]", icon: influencerIcon },
  { title: "Safe emotional space", color: "bg-[#E2DF69]", position: "lg:top-[50%] lg:left-[5%]", icon: emotionIcon },
  { title: "Verified listeners", color: "bg-[#93C5FD]", position: "lg:top-[50%] lg:right-[5%]", icon: earIcon },
  { title: "Private & secure conversations", color: "bg-[#F3B664]", position: "lg:top-[70%] lg:left-[10%]", icon: secureIcon },
  { title: "No judgment. No pressure.", color: "bg-[#BDC367]", position: "lg:top-[70%] lg:right-[10%]", icon: pressurIcon },
];
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-7xl px-6 lg:px-12 z-50 text-left mb-10">
        <h2 className="reveal-text text-[32px] sm:text-[42px]   font-bold text-[#202020] leading-[1.1] tracking-[-0.02em] uppercase">
          WHY PEACECHAT?
        </h2>
        
        <div className="flex flex-wrap items-center gap-x-4 lg:gap-x-6">
          <div className="relative inline-block reveal-text">
            <span className="text-[32px] sm:text-[42px]   font-bold text-pink leading-[1.1] tracking-[-0.02em] uppercase whitespace-nowrap">
              A SAFE SPACE.
            </span>
            <img
              src={yellowBrush}
          ...
          <span className="reveal-text text-[32px] sm:text-[42px]   font-bold text-[#202020] leading-[1.1] tracking-[-0.02em] uppercase whitespace-nowrap">
            ON YOUR TERMS.
          </span>
        </div>
          ...
          {cardsData.map((card, idx) => (
            ...
            >
              <div className={`${card.color} flex items-center gap-5 px-8 py-3 rounded-[16px] transition-all duration-500 group-hover:scale-105`}>
                ...
                <span className="text-white font-bold text-base tracking-tight whitespace-nowrap">{card.title}</span>
              </div>
            </div>
          ))}
        </div>
